...
│         │                  │                    │           │
│         │                  │                    │           │
│   Fast access        Shared state        Backup/audit       │
│   Fallback           across replicas     trail              │
│                                                              │
└─────────────────────────────────────────────────────────────┘
```
...
3. Write to Redis (async, if available)
...
| `SQLITE_PATH` | `/data/hermes.db` | SQLite database path |
